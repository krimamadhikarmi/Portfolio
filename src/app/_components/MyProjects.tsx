...
export function MyProjects() {
  ...
  return (
    <section id="my projects">
      <div className="flex flex-wrap justify-center items-center mt-14 sm:mt-20">
      ...
      {project_data.length > 3 && (
        <div className="flex justify-center mt-4 px-6">
          <Link
            href={"/projects"}
            className="ml-6 mb-6 px-6 py-3 w-full sm:w-fit text-white lg:px-8 lg:py-4 rounded-full bg-gradient-to-br from-green-500  to-red-500 hover:bg-slate-200 text-center text-base sm:text-lg lg:text-xl"
          >
            See More
          </Link>
        </div>
